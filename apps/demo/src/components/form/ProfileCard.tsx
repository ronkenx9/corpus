  ...
  const cardStyle = useMemo(
    () =>
      ({
        ...
        "--inner-gradient": innerGradient ?? undefined,
        "--behind-glow-color": behindGlowColor ?? undefined,
        "--behind-glow-size": behindGlowSize ?? undefined,
          ...
          <div className="pc-inside">
                ...
                <div className="pc-user-info">
                  ...
                  {contactHref ? (
                    <a
                      ...
                      aria-label={`Open passport for ${name}`}
                    >
                      {contactText}
                    </a>
                  ) : (
            ...
            <div className="pc-content">
              <div className="pc-details">
                {rubric && <div className="pc-rubric">{rubric}</div>}
                <h3>{name}</h3>
                <p>{title}</p>
              </div>
            </div>
